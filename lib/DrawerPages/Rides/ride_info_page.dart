    ...
    if (isNetwork) {
      try {
        ...
        data = {
          ...
          "distance": calculateDistance(double.parse(widget.model.latitude.toString()), double.parse(widget.model.longitude.toString()), double.parse(widget.model.dropLatitude.toString()), double.parse(widget.model.dropLongitude.toString())).toStringAsFixed(2),
        ...
        body: SafeArea(
          child:   widget.model.latitude!=null&&widget.model.latitude!=""?Stack(
            ...
            children: [
              ...
              !widget.model.bookingType!.contains("Point")&&widget.model.acceptReject!="3"&&widget.model.taxiId!=null?Align(
              ...
              Row(
                ...
                children: [
                  !widget.model.bookingType!.contains("Point")&&widget.model.driverId!=null?InkWell(
                    onTap: () {
                    ...
                    child:Container(
                      ...
                      decoration: boxDecoration(
                          ...
                          bgColor: Theme.of(context)
                              .primaryColor),
                      child: Center(
                          child: text(getTranslated(context, "CALL")!,
                              fontFamily: fontMedium,
                              fontSize: 8.sp,
                              isCentered: true,
                              textColor: Colors.white)),
            ...
            child: Column(
              ...
              /*  widget.model.promo_discount!=null&&widget.model.promo_discount!=""&&widget.model.promo_discount!="0"?AnimatedTextKit(
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      widget.model.driverName!=null?Container(
                        height: 60,
                        width: 60,
                        child: ClipRRect(
                      ...
                      Column(
                        ...
                        children: [
                          widget.model.driverName!=null?Text(
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Spacer(),
                          RowItem('RIDE_FARE', '\u{20B9} ${widget.model.amount}',
                              Icons.account_balance_wallet),
                          Spacer(),
                          RowItem('RIDE_TYPE',
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          double.parse(widget.model.promo_discount.toString())>0?Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              text("${getTranslated(context, "PROMO")} : ",
                                  ...
                                  textColor: Colors.black),
                              text(
                                  "- ₹" + double.parse(widget.model.promo_discount.toString()).toStringAsFixed(2),
                                  fontSize: 10.sp,
                                  fontFamily: fontRegular,
                                  textColor: Colors.black),
                            ],
