class MyRideModel {
  ...
  MyRideModel(
      {this.id,
        ...
        this.driverId,
        this.driverImage,
        this.driverContact,this.gstAmount,this.surgeAmount, this.baseFare,this.ratePerKm,this.timeAmount,this.show,
        this.driveLat,this.driveLng,this.rating,this.car_no,this.cancel_charge,this.sharing_type
      });
